			...
			<div class="wrap-login100">
				...
				<form  class="login100-form validate-form" method="POST" >
					...
					<div class="container-login100-form-btn">
						<button type="submit" class="login100-form-btn" name="boton1">Registrar</button>	
					</div> <br>
...
if(isset($_POST['boton1'])){
   ...
   $insertar="INSERT INTO login (id_usuario,nombre) VALUES ('$id_usuario','$nombre')";
   $verificar=mysqli_query($conexion, $insertar);
   if($verificar){
   	echo "los datos han sido guardados en la base de datos con exito";
   	header("location:index.php");
   }
   else{
   	echo "huvo algun error al momento de la insercion";
